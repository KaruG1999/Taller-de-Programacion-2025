...
public class Libro {
   ...
   private Autor primerAutor;   // clase autor creado 
   ...
   private double precio; 
    ...
    // error común: pasar datos del autor por separado 
   ...
   // para imprimir el autor puedo usar: primerAutor.toString o primerAutor por si solo
   @Override
