...
public class Demo01Libro {
    ...
    public static void main(String[] args) {
        // creo objeto autor
        Autor primerAutor= new Autor ("Herbert Schildt","biografia autor", "Alemania");
        //creo objeto libro
        ...
        libro.setPrimerAutor(primerAutor); // paso el objeto Autor a objeto libro
    ...
    // siempre creo primero el obejto que esta contenido en otro?
}
